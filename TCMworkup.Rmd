...
TCM_Curr %>% filter(Station=="JALD2"&
                    DT<as.POSIXct("2018-08-28 01:00:00", tz="GMT")) %>% 
  ggplot(aes(DT, Speed_cm_s))+
  geom_line()+
  theme_cowplot()

TCM_Curr %>% filter(Station=="EELD1"&
                    DT>as.POSIXct("2019-06-28 01:00:00", tz="GMT")&
                      DT<as.POSIXct("2019-07-05 01:00:00", tz="GMT")) %>% 
  ggplot(aes(DT, Speed_cm_s))+
...
TCM_Curr<-TCM_Curr%>%
  mutate(flags=
           case_when(Station=="JALD2"& DT>as.POSIXct("2018-08-27 01:00:00", tz="GMT")~"BAD",
                    Station=="EELD1"& DT>as.POSIXct("2019-06-29 05:00:00", tz="GMT")&DT<as.POSIXct("2019-07-04 20:00:00", tz="GMT") ~"QM"))
