...
# A cleaned-up version of [CTDworkup.Rmd](https://cbonsell.github.io/ble-instrumentation/CTDworkup) that only returns final dataset and plots.
...
* EELD1 looks like it got buried. Data flagged as QM (questionable)
* Data below freezing line flagged as INV (invalid)
* Other suspicious data (big linear drops in cond/sal) flagged as QM
