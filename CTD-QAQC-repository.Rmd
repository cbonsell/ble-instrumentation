...
* Data came from either RBR CTDs of Star Oddi CSTs
...
RBR <- read_csv("results/BLE LTER RBRCTD 2018to2019.csv") %>% 
  select(-flags_CondSal)# no calibrations were made, so can just show how the flag column was created from raw data
